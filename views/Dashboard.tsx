...
import { AdditionIcon, SubtractionIcon, ScalarMultiplicationIcon, MatrixMultiplicationIcon } from '../components/ModuleIcons';
            ...
            >
              <div>
                  <div className="flex items-start mb-3">
                    ...
                    <div>
                        <h3 className="text-2xl font-semibold text-sky-300 shiny-text">{module.name}</h3>
        ...
        >
            <div>
                <div className="flex items-start mb-3">
                    ...
                    <div>
                        <h3 className="text-2xl font-semibold text-purple-300 shiny-text">AI Chat</h3>
